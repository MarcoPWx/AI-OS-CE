...
import PaywallScreen from './screens/PaywallScreenClean'; // Using clean version
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Full App Test</Text>
      </View>
...
export default function App() {
  console.log('Full App with Paywall is rendering!');
