...
const exercises: Exercise[] = [
  {
    ...
    solution: 'Example prompt: "Create a React TypeScript NotificationBadge component with props: count (number), variant (info|warning|error), max (number, default 99). Show 99+ when count exceeds max. Include Storybook story with all variants."',
    learningOutcomes: [
  ...
  },
  {
    ...
    solution: 'The code has multiple issues: no async/await, accessing response before it exists, missing dependency handling. AI should identify these and provide proper async implementation.',
    learningOutcomes: [
  ...
  },
  {
    ...
    solution: 'AI should suggest: React.memo wrapper, useCallback for handlers, useMemo for expensive computations, key prop optimization, and React DevTools Profiler usage.',
    learningOutcomes: [
  ...
  },
  {
    ...
    solution: 'Custom useApi hook with <T> generic, AbortController cleanup, exponential backoff retry, and proper error boundaries.',
    learningOutcomes: [
  ...
  },
  {
    ...
    solution: 'Complete TDD cycle with comprehensive test suite, validation functions, and integration with React Hook Form or similar.',
    learningOutcomes: [
      'TDD methodology',
      'Test-first mindset',
      'Validation patterns',
  ...
  },
  {
    ...
    solution: 'WebSocket implementation with reconnection logic, state synchronization, and conflict resolution strategy.',
    learningOutcomes: [
  ...
  },
  {
    ...
    solution: 'Complete workflow with matrix testing, parallel jobs, artifact caching, and automated deployments.',
    learningOutcomes: [
      'CI/CD concepts',
  ...
  },
  {
    ...
    solution: 'AI should identify: dangerouslySetInnerHTML usage, missing ARIA labels, unnecessary re-renders, and suggest fixes.',
    learningOutcomes: [
      'Security awareness',
    ...
    <div style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '350px 1fr', gap: 24 }}>
        ...
        <div style={{
          ...
          <h3 style={{ fontSize: 16, fontWeight: 600, color: '#334155', marginBottom: 16 }}>
            Exercises
          </h3>
            ...
            {exercises.map(exercise => (
              <button
                ...
                style={{
                  padding: 12,
                  borderRadius: 8,
                  border: selectedExercise.id === exercise.id ? '2px solid #3b82f6' : '1px solid #e2e8f0',
                  background: selectedExercise.id === exercise.id ? '#eff6ff' : 
                            completedExercises.has(exercise.id) ? '#f0fdf4' : 'white',
                  cursor: 'pointer',
                  textAlign: 'left',
                  transition: 'all 0.2s'
                }}
        ...
        <div style={{
          ...
          <div style={{ marginBottom: 24 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
              ...
              <button
                onClick={() => setCurrentHint(Math.min(currentHint + 1, selectedExercise.hints.length))}
