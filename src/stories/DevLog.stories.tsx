// src/stories/DevLog.stories.tsx
  ...
  return (
    <div style={{ padding: 16, display: 'grid', gap: 12 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
        <h3 style={{ margin: 0 }}>Developer Log</h3>
...
const meta = {
  title: 'Docs/Dev Log',
  component: DevLogViewer,
  parameters: {
    helpDocs: [
      { href: '?path=/story/docs-repo-docs-browser--default', title: 'Repo Docs Browser' },
      { href: '/docs/status/DEVLOG.md', title: 'Open DEVLOG.md' },
    ],
    docs: {
      description: {
        component: 'Renders DEVLOG.md live from /docs with fallbacks to /api/docs/read?key=devlog. Shows Last updated from the docs manifest if present.'
      }
    }
  }
} satisfies Meta<typeof DevLogViewer>;
