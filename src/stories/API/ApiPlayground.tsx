...
const mockEndpoints: APIEndpoint[] = [
  {
    ...
    params: [
      ...
      { name: 'include', type: 'string', required: false, description: 'Include related data (posts, comments)' }
    ]
  },
  {
    id: '2',
    ...
    params: [
      ...
      { name: 'content', type: 'string', required: true, description: 'Post content in markdown' },
      { name: 'tags', type: 'array', required: false, description: 'Array of tag strings' },
      { name: 'published', type: 'boolean', required: false, description: 'Publish immediately' }
    ]
  },
  {
    id: '3',
    ...
    params: [
      ...
      { name: 'sort', type: 'string', required: false, description: 'Sort by: price, name, rating' }
    ]
  },
  {
    id: '4',
    ...
    requiresAuth: true,
    params: [
      { name: 'theme', type: 'string', required: false, description: 'UI theme: light, dark, auto' },
      { name: 'notifications', type: 'object', required: false, description: 'Notification preferences' },
...
const mockResponses: Record<string, any> = {
  ...
  '3': {
    ...
    data: {
      results: [
        { id: 'prod-1', name: 'Wireless Headphones', price: 99.99, rating: 4.5 },
        { id: 'prod-2', name: 'Mechanical Keyboard', price: 149.99, rating: 4.8 },
          ...
          <div style={{
            ...
            <div style={{
              ...
              {(['params', 'headers', 'body'] as const).map(tab => (
                ...
                >
                  {tab}
                  {tab === 'params' && selectedEndpoint.params && ` (${selectedEndpoint.params.length})`}
                </button>
              ))}
            </div>
              ...
              {activeTab === 'params' && (
                <div>
                  {selectedEndpoint.params && selectedEndpoint.params.length > 0 ? (
                    ...
                    <p style={{ color: '#94a3b8', fontSize: 14 }}>No parameters for this endpoint</p>
                  )}
                </div>
              )}
          ...
          {response && (
            <div style={{
              ...
              <div style={{
                ...
                <h4 style={{ fontSize: 14, fontWeight: 600, marginTop: 0, marginBottom: 12, color: '#475569' }}>
                  Headers
                </h4>
