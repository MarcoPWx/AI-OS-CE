...
const CICDWorkflow: React.FC = () => {
  ...
  const [workflowSteps, setWorkflowSteps] = useState<WorkflowStep[]>([
    ...
    { id: '3', name: 'Install Dependencies', status: 'success', duration: '45s' },
  ...
  const simulateWorkflow = () => {
    ...
    const steps = [...workflowSteps].map(s => ({ ...s, status: 'pending' as const }));
  ...
  const commonCommands = [
    ...
    { category: 'Testing', commands: [
      ...
      { cmd: 'npm run test:unit:coverage', desc: 'Run tests with coverage report' },
      { cmd: 'npm run test:stories', desc: 'Run Storybook accessibility tests' },
    ...
    { category: 'Git Workflow', commands: [
      { cmd: 'git checkout -b feature/name', desc: 'Create feature branch' },
      { cmd: 'git add -A && git commit -m "feat: description"', desc: 'Commit with conventional format' },
      { cmd: 'git push origin feature/name', desc: 'Push branch to remote' },
      { cmd: 'gh pr create --title "feat: title" --body "description"', desc: 'Create PR with GitHub CLI' }
    ]},
    { category: 'CI/CD', commands: [
        ...
        <div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
              <h2 style={{ fontSize: 20, fontWeight: 600, margin: 0, color: '#334155' }}>
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: 18, fontWeight: 600, marginBottom: 16, color: '#334155' }}>
              Branch Strategy
            </h3>
            <div style={{
              padding: 20,
          ...
          {prRules.map(rule => (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
                <h3 style={{ fontSize: 18, fontWeight: 600, margin: 0, color: '#334155' }}>
                  {rule.title}
                </h3>
                <span style={{
                  fontSize: 11,
              ...
              <p style={{ fontSize: 14, color: '#64748b', marginBottom: rule.example ? 12 : 0 }}>
                {rule.description}
              </p>
              {rule.example && (
                <div style={{
