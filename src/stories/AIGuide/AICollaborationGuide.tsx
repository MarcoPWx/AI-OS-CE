    ...
    <div style={{
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '300px 1fr', gap: 24 }}>
        ...
        <div style={{
          ...
          <h3 style={{ fontSize: 14, fontWeight: 600, color: '#64748b', marginBottom: 16, textTransform: 'uppercase' }}>
            Topics
          </h3>
        ...
        <div style={{
          ...
          {currentSection.examples && (
            <div style={{ marginBottom: 32 }}>
              <h3 style={{ fontSize: 20, fontWeight: 600, marginBottom: 16, color: '#334155' }}>
                Examples
              </h3>
              <div style={{
                background: '#f8fafc',
