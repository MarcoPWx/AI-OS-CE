...
- Is fully accessible (ARIA labels, keyboard navigation)`,
    ...
    example: 'Create a React component called UserCard that displays user information with props: user (name, email, avatar), onEdit, onDelete',
...
- Returns proper HTTP status codes`,
    variables: ['Method', 'Path', 'InputData', 'ResponseFormat', 'ValidationRules', 'ErrorCases', 'AuthType'],
...
4. Suggest how to prevent this in the future`,
    variables: ['ComponentName', 'ErrorMessage', 'ExpectedBehavior', 'ActualBehavior', 'CodeSnippet'],
...
7. Monitoring approach`,
    variables: ['SystemDescription', 'ScaleRequirements', 'PerformanceRequirements', 'BudgetConstraints'],
            ...
            {expandedPrompt === prompt.id && (
              <div style={{
                ...
                <div style={{ marginBottom: 16 }}>
                  <h4 style={{ fontSize: 13, fontWeight: 600, marginBottom: 8, color: '#334155' }}>
                    Template
                  </h4>
                  <pre style={{
                    padding: 12,
