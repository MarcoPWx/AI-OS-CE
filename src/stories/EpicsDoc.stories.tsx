// src/stories/EpicsDoc.stories.tsx
  ...
  return (
    <div style={{ padding: 16, display: 'grid', gap: 12 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
        <h3 style={{ margin: 0 }}>Epics (Canonical)</h3>
...
const meta = {
  title: 'Docs/Epics',
  component: EpicsDocViewer,
  parameters: {
    helpDocs: [
      { href: '/docs/roadmap/EPICS.md', title: 'Open EPICS.md' },
      { href: '/docs/status/EPIC_MANAGEMENT_CURRENT.md', title: 'Open Current Status' },
    ],
    docs: {
      description: {
        component: 'Renders EPICS.md (canonical) live from /docs with fallback to the current status page and to /api/docs/read?key=epic-management. Shows Last updated from the docs manifest if present.'
      }
    }
  }
} satisfies Meta<typeof EpicsDocViewer>;
